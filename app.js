...
const STORAGE_PREFIX = "karoliny:";
const GUIDELINES_VERSION = "insulin-lowgl-v3";
...
const karolinaMealOptions = [
  { name: "Jajka + pomidor", text: "2 jajka + pomidor 180 g + ogorek 100 g", portion: "jajka 100 g + pomidor 180 g + ogorek 100 g", grams: 380, components: [{ name: "jajka", grams: 100 }, { name: "pomidor", grams: 180 }, { name: "ogorek", grams: 100 }], kcal: 210, protein: 15, fat: 11, carbs: 12 },
  { name: "Jajka sadzone + warzywa", text: "2 jajka sadzone + pomidor + salata, bez pieczywa", portion: "jajka sadzone 110 g + pomidor 150 g + salata 80 g", grams: 340, components: [{ name: "jajka sadzone", grams: 110 }, { name: "pomidor", grams: 150 }, { name: "salata", grams: 80 }], kcal: 250, protein: 17, fat: 16, carbs: 10 },
  { name: "Omlet warzywny", text: "2 jajka + cukinia + szpinak, smazone na malej ilosci oliwy", portion: "jajka 100 g + cukinia 150 g + szpinak 80 g + oliwa 5 g", grams: 335, components: [{ name: "jajka", grams: 100 }, { name: "cukinia", grams: 150 }, { name: "szpinak", grams: 80 }, { name: "oliwa", grams: 5 }], kcal: 255, protein: 19, fat: 16, carbs: 11 },
  { name: "Ser bialy + warzywa", text: "Ser bialy poltlusty 150 g + ogorek + pomidor", portion: "ser bialy 150 g + ogorek 100 g + pomidor 100 g", grams: 350, components: [{ name: "ser bialy", grams: 150 }, { name: "ogorek", grams: 100 }, { name: "pomidor", grams: 100 }], kcal: 230, protein: 29, fat: 8, carbs: 12 },
  { name: "Serek homogenizowany bez cukru", text: "Serek homogenizowany naturalny/proteinowy bez cukru 150 g + maliny 60 g", portion: "serek homogenizowany 150 g + maliny 60 g", grams: 210, components: [{ name: "serek homogenizowany", grams: 150 }, { name: "maliny", grams: 60 }], kcal: 210, protein: 20, fat: 7, carbs: 16 },
  { name: "Twarog z rzodkiewka", text: "Ser bialy 160 g + rzodkiewka + ogorek, bez dodatkow mlecznych", portion: "ser bialy 160 g + rzodkiewka 80 g + ogorek 100 g", grams: 340, components: [{ name: "ser bialy", grams: 160 }, { name: "rzodkiewka", grams: 80 }, { name: "ogorek", grams: 100 }], kcal: 230, protein: 31, fat: 8, carbs: 11 },
  { name: "Kanapki low carb z indykiem", text: "Pieczywo low carb 60 g + wedlina z indyka 90 g + warzywa", portion: "pieczywo low carb 60 g + wedlina z indyka 90 g + warzywa 150 g", grams: 300, components: [{ name: "pieczywo low carb", grams: 60 }, { name: "wedlina z indyka", grams: 90 }, { name: "warzywa", grams: 150 }], kcal: 320, protein: 33, fat: 10, carbs: 25 },
  { name: "Tunczyk + jajko + warzywa", text: "Tunczyk w sosie wlasnym + jajko + ogorek i salata", portion: "tunczyk 120 g + jajko 50 g + ogorek 120 g + salata 80 g", grams: 370, components: [{ name: "tunczyk", grams: 120 }, { name: "jajko", grams: 50 }, { name: "ogorek", grams: 120 }, { name: "salata", grams: 80 }], kcal: 235, protein: 38, fat: 7, carbs: 8 },
  { name: "Kurczak + kasza gryczana", text: "Kurczak 150 g + kasza gryczana gotowana 80 g + salata", portion: "kurczak 150 g + kasza gryczana 80 g + salata 150 g", grams: 380, components: [{ name: "kurczak", grams: 150 }, { name: "kasza gryczana", grams: 80 }, { name: "salata", grams: 150 }], kcal: 390, protein: 51, fat: 8, carbs: 31 },
  { name: "Indyk + warzywa + kasza", text: "Indyk 160 g + warzywa parowane + kasza gryczana 70 g", portion: "indyk 160 g + warzywa 250 g + kasza gryczana 70 g", grams: 480, components: [{ name: "indyk", grams: 160 }, { name: "warzywa", grams: 250 }, { name: "kasza gryczana", grams: 70 }], kcal: 405, protein: 55, fat: 7, carbs: 34 },
  { name: "Dorsz + fasolka", text: "Dorsz/mintaj 220 g + fasolka szparagowa 250 g + oliwa 5 g", portion: "dorsz 220 g + fasolka szparagowa 250 g + oliwa 5 g", grams: 475, components: [{ name: "dorsz", grams: 220 }, { name: "fasolka szparagowa", grams: 250 }, { name: "oliwa", grams: 5 }], kcal: 320, protein: 48, fat: 8, carbs: 18 },
  { name: "Losos mala porcja + salata", text: "Losos 120 g + duza salata + ogorek, bez sosu cukrowego", portion: "losos 120 g + salata 120 g + ogorek 150 g", grams: 390, components: [{ name: "losos", grams: 120 }, { name: "salata", grams: 120 }, { name: "ogorek", grams: 150 }], kcal: 310, protein: 29, fat: 16, carbs: 8 },
  { name: "Pulpeciki z indyka + cukinia", text: "Pulpeciki z indyka 180 g + cukinia duszona 250 g", portion: "pulpeciki z indyka 180 g + cukinia 250 g", grams: 430, components: [{ name: "pulpeciki z indyka", grams: 180 }, { name: "cukinia", grams: 250 }], kcal: 390, protein: 42, fat: 18, carbs: 14 },
  { name: "Kurczak + brokul mala porcja", text: "Kurczak 160 g + brokul gotowany 150 g + salata; brokul tylko jesli ma ochote", portion: "kurczak 160 g + brokul 150 g + salata 100 g", grams: 410, components: [{ name: "kurczak", grams: 160 }, { name: "brokul", grams: 150 }, { name: "salata", grams: 100 }], kcal: 340, protein: 54, fat: 7, carbs: 15 },
  { name: "Kurczak + cukinia + pomidor", text: "Kurczak 170 g + cukinia + pomidor, niski ladunek glikemiczny", portion: "kurczak 170 g + cukinia 220 g + pomidor 120 g", grams: 510, components: [{ name: "kurczak", grams: 170 }, { name: "cukinia", grams: 220 }, { name: "pomidor", grams: 120 }], kcal: 360, protein: 56, fat: 8, carbs: 16 },
  { name: "Chuda wolowina + surowka", text: "Chuda wolowina 150 g + surowka bez cukru + ogorek", portion: "chuda wolowina 150 g + surowka 180 g + ogorek 100 g", grams: 430, components: [{ name: "chuda wolowina", grams: 150 }, { name: "surowka", grams: 180 }, { name: "ogorek", grams: 100 }], kcal: 400, protein: 43, fat: 17, carbs: 16 },
  { name: "Schab pieczony chudy + salata", text: "Schab pieczony bez tlustych sosow + salata i ogorek", portion: "schab pieczony 160 g + salata 120 g + ogorek 120 g", grams: 400, components: [{ name: "schab pieczony", grams: 160 }, { name: "salata", grams: 120 }, { name: "ogorek", grams: 120 }], kcal: 390, protein: 46, fat: 18, carbs: 8 },
  { name: "Zupa jarzynowa low GL", text: "Zupa bez ziemniakow i maki + kurczak 120 g", portion: "zupa jarzynowa 350 g + kurczak 120 g", grams: 470, components: [{ name: "zupa jarzynowa", grams: 350 }, { name: "kurczak", grams: 120 }], kcal: 315, protein: 39, fat: 10, carbs: 18 },
  { name: "Rosol + mieso bez makaronu", text: "Rosol czysty 400 ml + mieso kurczaka 130 g, bez makaronu", portion: "rosol 400 g + kurczak 130 g", grams: 530, components: [{ name: "rosol", grams: 400 }, { name: "kurczak", grams: 130 }], kcal: 300, protein: 38, fat: 12, carbs: 7 },
  { name: "Pomidorowa z jajkiem", text: "Pomidorowa lagodna bez maki + jajko, bez makaronu", portion: "pomidorowa 350 g + jajko 50 g", grams: 400, components: [{ name: "pomidorowa", grams: 350 }, { name: "jajko", grams: 50 }], kcal: 240, protein: 16, fat: 12, carbs: 20 },
  { name: "Salatka kurczak + ser bialy", text: "Kurczak 150 g + ser bialy 80 g + warzywa", portion: "kurczak 150 g + ser bialy 80 g + warzywa 180 g", grams: 410, components: [{ name: "kurczak", grams: 150 }, { name: "ser bialy", grams: 80 }, { name: "warzywa", grams: 180 }], kcal: 385, protein: 58, fat: 10, carbs: 13 },
  { name: "Salatka tunczyk + fasola mala", text: "Tunczyk + salata + fasola/ciecierzyca 60 g dla niskiego ladunku", portion: "tunczyk 120 g + salata 150 g + fasola 60 g", grams: 330, components: [{ name: "tunczyk", grams: 120 }, { name: "salata", grams: 150 }, { name: "fasola", grams: 60 }], kcal: 285, protein: 39, fat: 4, carbs: 22 },
  { name: "Ciecierzyca mala + kurczak", text: "Kurczak 150 g + ciecierzyca 70 g + warzywa, mala porcja wegli", portion: "kurczak 150 g + ciecierzyca 70 g + warzywa 180 g", grams: 400, components: [{ name: "kurczak", grams: 150 }, { name: "ciecierzyca", grams: 70 }, { name: "warzywa", grams: 180 }], kcal: 410, protein: 52, fat: 8, carbs: 33 },
  { name: "Kantyna: chude mieso + surowka", text: "Chude mieso 110 g + surowka 150 g, bez ziemniakow/ryzu/makaronu", portion: "chude mieso 110 g + surowka 150 g", grams: 260, components: [{ name: "chude mieso", grams: 110 }, { name: "surowka", grams: 150 }], kcal: 230, protein: 30, fat: 7, carbs: 10 },
  { name: "Kantyna: ryba + surowka", text: "Ryba bez panierki 130 g + surowka 150 g, bez dodatkow skrobiowych", portion: "ryba 130 g + surowka 150 g", grams: 280, components: [{ name: "ryba", grams: 130 }, { name: "surowka", grams: 150 }], kcal: 260, protein: 32, fat: 8, carbs: 11 },
  { name: "Kolacja: ser bialy", text: "Ser bialy 140 g + ogorek + rzodkiewka", portion: "ser bialy 140 g + ogorek 120 g + rzodkiewka 80 g", grams: 340, components: [{ name: "ser bialy", grams: 140 }, { name: "ogorek", grams: 120 }, { name: "rzodkiewka", grams: 80 }], kcal: 205, protein: 27, fat: 7, carbs: 10 },
  { name: "Kolacja: jajko + tunczyk", text: "Jajko + tunczyk + salata, malo wegli", portion: "jajko 50 g + tunczyk 100 g + salata 120 g", grams: 270, components: [{ name: "jajko", grams: 50 }, { name: "tunczyk", grams: 100 }, { name: "salata", grams: 120 }], kcal: 205, protein: 32, fat: 6, carbs: 5 },
  { name: "Kolacja: serek homogenizowany", text: "Serek homogenizowany bez cukru + kilka malin", portion: "serek homogenizowany 150 g + maliny 50 g", grams: 200, components: [{ name: "serek homogenizowany", grams: 150 }, { name: "maliny", grams: 50 }], kcal: 205, protein: 20, fat: 7, carbs: 15 },
  { name: "Przekaska: jajko + warzywa", text: "1 jajko + ogorek/pomidor", portion: "jajko 50 g + warzywa 180 g", grams: 230, components: [{ name: "jajko", grams: 50 }, { name: "warzywa", grams: 180 }], kcal: 115, protein: 8, fat: 5, carbs: 9 },
  { name: "Przekaska: ser bialy mala", text: "Ser bialy 100 g + rzodkiewka", portion: "ser bialy 100 g + rzodkiewka 80 g", grams: 180, components: [{ name: "ser bialy", grams: 100 }, { name: "rzodkiewka", grams: 80 }], kcal: 145, protein: 20, fat: 5, carbs: 6 },
  { name: "Przekaska: hummus mala porcja", text: "Hummus 40 g + warzywa; kontroluj porcje", portion: "hummus 40 g + warzywa 180 g", grams: 220, components: [{ name: "hummus", grams: 40 }, { name: "warzywa", grams: 180 }], kcal: 170, protein: 6, fat: 8, carbs: 17 }
];

function buildCatalog() {
  const seen = new Set();
  return karolinaMealOptions
    .filter(item => {
...
const karolinaProductCatalog = [
  { id: "homogenized_no_sugar", name: "Serek homogenizowany bez cukru", unit: "g", kcal100: 110, protein100: 12, fat100: 4, carbs100: 8 },
  { id: "white_cheese", name: "Ser bialy poltlusty", unit: "g", kcal100: 130, protein100: 18, fat100: 5, carbs100: 4 },
  { id: "white_cheese_lean", name: "Ser bialy chudy", unit: "g", kcal100: 100, protein100: 19, fat100: 1, carbs100: 4 },
  { id: "lean_beef", name: "Chuda wolowina", unit: "g", kcal100: 180, protein100: 28, fat100: 7, carbs100: 0 },
  { id: "lean_pork_loin", name: "Schab chudy pieczony", unit: "g", kcal100: 190, protein100: 29, fat100: 8, carbs100: 0 },
  { id: "lentils_cooked", name: "Soczewica gotowana mala porcja", unit: "g", kcal100: 116, protein100: 9, fat100: 0, carbs100: 20 },
  { id: "chickpeas_cooked", name: "Ciecierzyca gotowana mala porcja", unit: "g", kcal100: 164, protein100: 9, fat100: 3, carbs100: 27 },
  { id: "beans_cooked", name: "Fasola gotowana mala porcja", unit: "g", kcal100: 125, protein100: 8, fat100: 1, carbs100: 22 },
  { id: "hummus", name: "Hummus", unit: "g", kcal100: 240, protein100: 8, fat100: 15, carbs100: 18 },
  { id: "low_carb_bread_karolina", name: "Pieczywo low carb", unit: "g", kcal100: 230, protein100: 18, fat100: 9, carbs100: 16 }
];

const bannedProductWords = [
  "mleko", "jogurt", "kefir", "skyr", "mozzarella", "feta", "gouda", "edamski", "camembert", "brie", "parmezan",
  "ser zolty", "serek kremowy", "serek wiejski", "cottage", "smietana", "smietanka", "mleczko", "mascarpone", "ricotta",
  "halloumi", "plesniowy", "boczek", "karkowka", "golonka", "zeberka", "lopatka", "kielbasa", "kabanos", "parowki",
  "salami", "kaszanka", "pasztet", "kaczka", "duck", "brukselka", "cytr",
  "pomarancz", "mandarynk", "grejpfrut", "cytryna", "limonka", "owsianka", "platki owsiane"
];

function isKarolinaAllowedProduct(product) {
  const text = `${product.name} ${product.id}`.toLowerCase();
  if (text.includes("serek homogenizowany") || text.includes("ser bialy") || text.includes("twarog")) return true;
  return !bannedProductWords.some(word => text.includes(word));
}

function getCustomMeals() {
  return JSON.parse(localStorage.getItem(appKey("customMeals")) || "[]");
}

function setCustomMeals(meals) {
  localStorage.setItem(appKey("customMeals"), JSON.stringify(meals));
}
...
function allCustomProducts() {
  const seen = new Set();
  return karolinaProductCatalog.concat(customProductCatalog, expandedProductCatalog).filter(isKarolinaAllowedProduct).filter(product => {
...
const shoppingPlan = [
  {
    ...
    items: [
      ...
      ["Dorsz, mintaj albo mala porcja lososia", "0,8-1 kg"],
      ["Tunczyk w sosie wlasnym", "3-4 puszki"]
    ]
  },
  {
    category: "Dozwolony nabial",
    items: [
      ["Ser bialy/twarog", "2-3 kostki"],
      ["Serek homogenizowany bez cukru", "4-6 szt."]
    ]
  },
  {
    category: "Warzywa",
    items: [
      ["Brokul", "mala ilosc, jesli ma ochote"],
  ...
  },
  {
    ...
    items: [
      ["Oliwa", "1 butelka"],
      ["Kasza gryczana", "mala paczka"],
      ["Ciecierzyca/fasola", "male porcje"],
...
let selectedDay = Number(localStorage.getItem(appKey("selectedDay")) ?? String(currentPlanDayIndex()));
...
function storageKeyForDay(type, day) {
  ...
  if (type === "plan") return appKey(`plan:week:day${day}`);
  return appKey(`${type}:${date}:day${day}`);
}

function oldDailyPlanKey(day) {
  return appKey(`plan:${localDateKey()}:day${day}`);
}
...
function getShoppingDone() {
  return JSON.parse(localStorage.getItem(appKey("shoppingDone")) || "[]");
}

function setShoppingDone(done) {
  localStorage.setItem(appKey("shoppingDone"), JSON.stringify(done));
}

function getResults() {
  return JSON.parse(localStorage.getItem(appKey("results")) || "[]");
}

function setResults(results) {
  localStorage.setItem(appKey("results"), JSON.stringify(results));
}
...
function suggestDayPlan() {
  ...
  const used = new Set();
  const lightBySlot = [
    ["Jajka + pomidor", "Omlet warzywny", "Ser bialy + warzywa", "Twarog z rzodkiewka"],
    ["Serek homogenizowany bez cukru", "Tunczyk + jajko + warzywa", "Przekaska: ser bialy mala", "Przekaska: jajko + warzywa"],
    ["Kolacja: jajko + tunczyk", "Kolacja: ser bialy", "Tunczyk + jajko + warzywa", "Przekaska: hummus mala porcja"],
    ["Kolacja: ser bialy", "Kolacja: serek homogenizowany", "Twarog z rzodkiewka", "Przekaska: jajko + warzywa"]
  ];
  const dinnerBySlot = [
    ["Rosol + mieso bez makaronu", "Pomidorowa z jajkiem", "Zupa jarzynowa low GL", "Kurczak + cukinia + pomidor"],
    ["Kurczak + kasza gryczana", "Indyk + warzywa + kasza", "Dorsz + fasolka", "Kurczak + brokul mala porcja"],
    ["Dorsz + fasolka", "Pulpeciki z indyka + cukinia", "Chuda wolowina + surowka", "Salatka kurczak + ser bialy"],
    ["Schab pieczony chudy + salata", "Salatka tunczyk + fasola mala", "Ciecierzyca mala + kurczak", "Kurczak + cukinia + pomidor"]
  ];
...
function suggestProducts(item, grams, addProduct) {
  ...
  if (text.includes("twarog") || text.includes("ser bialy")) addProduct("Ser bialy/twarog", amount);
  if (text.includes("serek homogenizowany")) addProduct("Serek homogenizowany bez cukru", amount);
  ...
  if (text.includes("pomidor")) addProduct("Pomidory", amount);
  if (text.includes("rzodkiew")) addProduct("Rzodkiewka", amount);
  ...
  if (text.includes("ciecierzyca")) addProduct("Ciecierzyca", amount);
  if (text.includes("fasola")) addProduct("Fasola", amount);
  if (text.includes("makaron")) addProduct("Makaron low carb lub minimalna porcja", item.name);
  if (text.includes("ryz")) addProduct("Ryz", "mala porcja");
  if (text.includes("kasza")) addProduct("Kasza gryczana", "mala porcja");
...
function notificationLoop() {
  ...
  times.forEach((time, index) => {
    const key = appKey(`notify:meal:${stamp}:${index}`);
  ...
  const drinkKey = appKey(`notify:drink:${stamp}`);
  if (settings.notifications && Notification.permission === "granted" && isCurrentMinute(settings.drinkTime) && !localStorage.getItem(drinkKey)) {
    new Notification("Woda", { body: "Wypij szklanke wody." });
...
function bindEvents() {
  ...
  document.getElementById("daySelect").addEventListener("change", event => {
    ...
    localStorage.setItem(appKey("selectedDay"), String(selectedDay));
    renderMeals();
  });
